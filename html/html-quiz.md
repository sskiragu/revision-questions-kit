...
```html
<form method="post" action="mailto:info@revision.com" ____="text/plain"></form>
```
...
```html
<base href="http://www.revision.com/dir/" />
```

- [x] `http://www.revision.com/dir/page.html`
- [ ] `page.html`
- [ ] `http://www.revision.com/page.html`
- [ ] `dir/page.html`
...
<address>
  ...
  <a href="mailto:info@revision.com">info@revision.com</a>
</address>
```
