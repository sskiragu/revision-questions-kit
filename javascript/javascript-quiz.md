...
#### Q119. Which statement can be used to select the element from the DOM containing the text "The revision Learning library has great JavaScript courses" from this markup?

```html
<h1 class="content">revision Learning</h1>
<div class="content">
  <span class="content">The revision Learning library has great JavaScript courses!</span>
</div>
```
